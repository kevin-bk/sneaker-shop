...
final class MemberController extends SiteController
{
    ...
    public function login()
    {
        ...
        return view( $this->layout.'account.login', $this->render($data));
    ...
    public function register()
    {
        ...
        return view($this->layout.'account.register', $this->render($data));
    }
    ...
    public function forgot()
    {
        ...
        return view('layout.ant_furniture.account.forgot', $this->render($data));
    }
