                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive-sm">
                        <table class="table table-bordered table-striped">
                            ...
                            @if($saleOrder->sale_order_lines->count() > 0)
                                @foreach($saleOrder->sale_order_lines as $key => $saleOrderLine)
                                    <tr>
                                        ...
                                        <td class="left">{{ $saleOrderLine->size }}</td>
                            ...
                            <tr>
                                <td colspan="6" class="text-right"><strong>Giảm giá</strong></td>
                            ...
                            <tr>
                                <td colspan="6" class="text-right"><strong>Giá cuối:</strong></td>
                                <td>
