                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input class="form-control @error('billing_fullname') is-invalid @enderror"
                                        name="billing_fullname" required value="{{$member->fullname}}"
                                        placeholder="{{ trans('common.fullname') }}/ Fullname" autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input class="form-control @error('billing_email') is-invalid @enderror"
                                        value="{{$member->email}}" required name="billing_email" type="email"
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input class="form-control @error('billing_phone') is-invalid @enderror"
                                        name="billing_phone" required value="{{$member->phone}}"
                                        placeholder="{{ trans('common.phone') }}/ Phonenumber" autocomplete="off">
                                    @error('billing_phone')
                                    <div class="text text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input class="form-control" name="billing_address"
                                        ...
                                        placeholder="{{ trans('common.address') }}/ Address" autocomplete="off">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <textarea class="form-control" autocomplete="off" name="note"
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input class="form-control @error('billing_fullname') is-invalid @enderror"
                                        name="billing_fullname" required value="{{ old('billing_fullname') }}"
                                        placeholder="{{ trans('common.fullname') }}/ Fullname" autocomplete="off">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input class="form-control @error('billing_email') is-invalid @enderror"
                                        value="{{ old('billing_email') }}" required name="billing_email" type="email"
                                        autocomplete="off" placeholder="Email">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input class="form-control @error('billing_phone') is-invalid @enderror"
                                        name="billing_phone" required value="{{ old('billing_phone') }}"
                                        placeholder="{{ trans('common.phone') }}/ Phonenumber" autocomplete="off">
                                    @error('billing_phone')
                                    <div class="text text-danger">{{ $message }}</div>
                                    @enderror
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        ...
                                        @if($item->associatedModel->price > $item->associatedModel->price_promotion &&
                                        $item->associatedModel->price_promotion > 0)
                                        <br>
                                        <s
                                            style="color: #ccc; font-size: 11px">{{ number_format($item->associatedModel->price) }}</s>
                                        @endif
                                    </td>
                                </tr>
                                @endforeach
