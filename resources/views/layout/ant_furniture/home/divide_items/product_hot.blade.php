        ...
        <div class="col-md-12 e-tabs not-dqtab ajax-tab-1" data-section="ajax-tab-1">
            <div class="content">
                <div class="tab-1 tab-content">
                    <div class="section-tour-owl2 products products-view-grid owl-carousel">
                            ...
                            <div class="ant-product-item">
                                ...
                                <div class="box-info">
                                    <h2 class="product-item-name">
                                        <a title="{{$item->title}}" href="{{$item->link}}" class="product-item-link">
                                            {{$item -> title}}
                                        </a>
                                    </h2>
                                        ...
                                        <div class="add-to-links">
                                            <div class="actions-primary">
                                                <form action="{{ base_url('cart/add') }}" method="post"
                                                    class="variants form-nut-grid" data-id="product-actions-12668688"
